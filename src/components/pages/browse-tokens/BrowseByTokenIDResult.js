...
<div className="search-results my-3 p-3">
    ...
    {props.tokenSearchResults && props.tokenSearchResults?.id && props.tokenSearchResults?.tokenExists && (<BrowseByTokenIDResultShow tokenID={props.tokenSearchResults?.id} />)}
    {props.tokenSearchResults && (props.tokenSearchResults?.tokenExists===false) && (<BrowseByTokenIDNotFound />)}
</div>)
}
